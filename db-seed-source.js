...
db.serialize(() => {
  ...
  const productosIniciales = [
    // --- BOCADITOS DULCES ---
    ['dulce_alfajorcito_choco', 'Alfajorcito de Chocolate', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_alfajorcito_manjar', 'Alfajorcito de Manjar', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_biscotelas', 'Biscotelas', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_brownies', 'Brownies', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_budin', 'Budin', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_cisne', 'Cisne', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_cocaditas', 'Cocaditas', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_conitos_manjar', 'Conitos de Manjar', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_donitas', 'Donitas', 'Bocaditos Dulces', 76, 25, 45, 76, null],
    ['dulce_kekito_zanahoria', 'Kekito de Zanahoria', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_merenguitos', 'Merenguitos', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_mil_hojas', 'Mil Hojas', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_mini_muffin', 'Mini Muffin', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_mousse_fresa', 'Mousse de Fresa', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_mousse_maracuya', 'Mousse de Maracuyá', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_mousse_lucuma', 'Mousse de Lúcuma', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_niditos_amor', 'Niditos de Amor', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_orejitas', 'Orejitas', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_panuelitos_manjar', 'Pañuelitos de Manjar', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_pastelito_choclo', 'Pastelito de Choclo', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_piononitos', 'Piononitos', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_piononitos_chantilly', 'Piononitos de Chantilly', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_pye_limon', 'Pye de Limón', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_pye_manzana', 'Pye de Manzana', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_pye_pina', 'Pye de Piña', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_relampago_choco', 'Relámpago de Chocolate', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tartaleta_coco', 'Tartaleta de Coco', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_tartaleta_durazno', 'Tartaleta de Durazno', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tartaleta_fresa', 'Tartaleta de Fresa', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tartaleta_sauco', 'Tartaleta de Sauco', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tartaleta_lucuma', 'Tartaleta de Lúcuma', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tartaleta_guanabana', 'Tartaleta de Guanabana', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tortita_choco', 'Tortita de Chocolate', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tortita_helada', 'Tortita Helada', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tortita_selva_negra', 'Tortita Selva Negra', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_tortita_tres_leches', 'Tortita Tres Leches', 'Bocaditos Dulces', 85, 25, 45, 85, null],
    ['dulce_trufas', 'Trufas', 'Bocaditos Dulces', 76, 22, 40, 76, null],
    ['dulce_trufa_blanca', 'Trufa blanca', 'Bocaditos Dulces', 85, 25, 45, 85, null],

    // --- BOCADITOS SALADOS ---
    ['salado_pizzitas', 'Pizzitas', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_empanaditas_aji_gallina', 'Empanaditas de Aji de Gallina', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_empanaditas_aceituna', 'Empanaditas de Aceituna', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_empanaditas_carne', 'Empanaditas de Carne', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_empanaditas_jamon', 'Empanaditas de Jamón', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_empanaditas_pollo', 'Empanaditas de Pollo', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_empanaditas_queso', 'Empanaditas de Queso', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_empanaditas_mixtas', 'Empanaditas Mixtas', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_enrollado_acelga', 'Enrollado de Acelga', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_enrollado_hotdog', 'Enrollado de Hot Dog', 'Bocaditos Salados', 80, 22, 40, 80, null],
    ['salado_soufle_alcachofa', 'Soufle de Alcachofa', 'Bocaditos Salados', 80, 22, 40, 80, null],

    // --- SANDWICHITOS ---
    ['sw_asado', 'Sandwich de Asado', 'Sandwichitos', 160, 40, 80, 160, null],
    ['sw_croissant_pollo', 'Croissant con Pollo', 'Sandwichitos', 160, 40, 80, 160, null],
    ['sw_lomito', 'Sandwich de Lomito', 'Sandwichitos', 160, 40, 80, 160, null],
    ['sw_petipan_pollo_durazno', 'Petipan de pollo c/durazno', 'Sandwichitos', 160, 40, 80, 160, null],
    ['sw_petipan_pollo_pina', 'Petipan de pollo c/piña', 'Sandwichitos', 160, 40, 80, 160, null],
    ['sw_salchicha_nortena', 'Sandwich de Salchicha norteña', 'Sandwichitos', 140, 40, 70, 140, null],
    ['sw_petipan_pollo', 'Petipan de Pollo', 'Sandwichitos', 140, 40, 70, 140, null],
    ['sw_caprece', 'Caprece Mozz/Alb/Tomate', 'Sandwichitos', 120, 35, 60, 120, null],
    ['sw_hamburguesita', 'Sandwich Hamburguesita', 'Sandwichitos', 120, 35, 60, 120, null],
    ['sw_croissant_mixto', 'Croissant Mixto', 'Sandwichitos', 100, 28, 50, 100, null],
    ['sw_butifarras', 'Butifarras', 'Sandwichitos', 100, 28, 50, 100, null],
    ...
    // --- MINI TRIPLES ---
    ['triple_jamon_queso', 'Triple de Jamón y queso', 'Mini Triples', 120, 30, 60, 120, null],
    ['triple_palta_tomate_huevo', 'Triple palta, tomate, huevo', 'Mini Triples', 140, 45, 75, 140, null],
    ['triple_pollo_jamon_queso', 'Triple pollo, jamón, queso', 'Mini Triples', 130, 40, 70, 130, null],
    ['triple_pollo_durazno', 'Triple pollo con durazno', 'Mini Triples', 140, 45, 75, 140, null],
    ['triple_espinaca_queso_crema', 'Triple espinaca y queso crema', 'Mini Triples', 130, 40, 70, 130, null],
    ['triple_mermelada_queso_crema', 'Triple mermelada y queso crema', 'Mini Triples', 130, 40, 70, 130, null],
    ['triple_pollo_lomo_ahumado', 'Triple pollo y lomo ahumado', 'Mini Triples', 130, 40, 70, 130, null],
    ['triple_pollo_tocino', 'Triple pollo y tocino', 'Mini Triples', 130, 40, 70, 130, null],
    ['triple_pollo_aceituna', 'Triple pollo con aceituna', 'Mini Triples', 130, 40, 70, 130, null],
    ['triple_pollo_pina', 'Triple pollo con piña', 'Mini Triples', 140, 45, 75, 140, null],
    ['triple_pollo_pecanas_jamon', 'Triple pollo, pecanas y jamón', 'Mini Triples', 130, 40, 70, 130, null],

    // --- PIQUEOS ---
    ['piqueo_brochetas_pollo', 'Brochetas de pollo', 'Piqueos', 260, 70, 130, 260, null],
    ['piqueo_alitas_bouchet', 'Alitas bouchet', 'Piqueos', 260, 70, 130, 260, null],
    ['piqueo_guindones_tocino', 'Guindones c/tocino', 'Piqueos', 140, 40, 70, 140, null],
    ['piqueo_enrollado_jamon_esparragos', 'Enrollado de jamón c/esparragos', 'Piqueos', 80, 30, 40, 80, null],
    ['piqueo_hojarascas_aji_gallina', 'Hojarascas de ají de gallina', 'Piqueos', 80, 30, 40, 80, null],
    ['piqueo_piononitos_espinaca', 'Piononitos de espinaca', 'Piqueos', 80, 30, 40, 80, null],
    ['piqueo_tequenos_guacamole', 'Tequeños con guacamole', 'Piqueos', 100, 30, 50, 100, null],
    ['piqueo_voulevans_jamon', 'Voulevans de jamón', 'Piqueos', 80, 30, 40, 80, null],
    ['piqueo_voulevans_tocino', 'Voulevans de tocino', 'Piqueos', 80, 30, 40, 80, null],
    ['piqueo_canapes_jamon_pina_durazno', 'Canapés jamón, piña, durazno', 'Piqueos', 80, 30, 40, 80, null],

    // --- PASTELES FAMILIARES ---
    ['fam_crema_volteada', 'Crema Volteada', 'Pasteles Familiares', 60.0, null, null, null, 60.0],
    ['fam_mousse_fresa', 'Torta Mousse de Fresa', 'Pasteles Familiares', 60.0, null, null, null, 60.0],
    ['fam_mousse_maracuya', 'Torta Mousse de Maracuyá', 'Pasteles Familiares', 60.0, null, null, null, 60.0],
    ...
    ['fam_pye_manzana', 'Torta Pye de Manzana', 'Pasteles Familiares', 60.0, null, null, null, 60.0],
    ['fam_pye_limon', 'Torta Pye de Limón', 'Pasteles Familiares', 60.0, null, null, null, 60.0],
    ...
    ['gourmet_petipan', 'Petipan', 'Pan Gourmet', 0, 9, 18, 30, null],
  ...
  db.run(`DELETE FROM productos WHERE id IN (
    ...
    'dulce_tortita_helada_selva', 'extra_torta_chocolate', 'extra_torta_selva_negra',
    'extra_torta_helada', 'extra_torta_mousse_fresa', 'extra_torta_mousse_maracuya',
    'extra_torta_pye_manzana', 'extra_torta_pye_limon', 'extra_torta_keke_pasas',
